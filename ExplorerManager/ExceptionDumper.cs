...
namespace ExplorerManager
{
    ...
    {
        public static string DumpException(Exception exception, string fileName = "LastError.log")
        {
            ...
            using (var streamWriter = new StreamWriter(new FileStream(fileName, FileMode.Append, FileAccess.Write, FileShare.Write), Encoding.UTF8))
            {
